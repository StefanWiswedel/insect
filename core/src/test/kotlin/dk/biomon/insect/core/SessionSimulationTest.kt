...
class SessionSimulationTest {
    ...
    private fun decisionAt(x: Float?, index: Long) = dk.biomon.insect.core.trigger.TriggerDecision(
        ...
        assessment = dk.biomon.insect.core.illumination.IlluminationAssessment(
            dk.biomon.insect.core.illumination.IlluminationVerdict.DETECTION,
            dk.biomon.insect.core.illumination.IlluminationSignals.EMPTY,
            false, false, false,
        ),
        illumination = false,
        rebaselinedPixels = 0,
